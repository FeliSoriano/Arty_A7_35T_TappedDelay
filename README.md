...
- Arty_TDC_v05 $\rightarrow$ ethernet was removed and custom Arty_AXITDC_v01 was added. This version only looks to test the MicroBlaze - AXITDC connection, using some leds. As such, all critical timing\-related warnings were ignored. This version also fails to do anything. Details on tablet.
